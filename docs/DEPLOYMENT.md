...
gcloud run jobs update watch-compare-crawler --region asia-east1 \
  --update-env-vars=CRAWL_SOURCES=hourstack,rdwatch,jackroad,watchnian,commitwatch,sevenhours,lips,allu,housekihiroba,ishida,rww,watchfinderhk,wristcheck,kenwatches,rasin,quark,bellemonde
