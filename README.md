...
**Chrono24, eBay, Watchnian, Jackroad and Hourstack** into PostgreSQL; a Next.js frontend lets you
...
make crawl ARGS="-sources=jackroad,hourstack,watchnian -max-pages=2"
