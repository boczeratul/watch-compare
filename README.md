...
**Chrono24, eBay, Watchnian, Jackroad, Commit Ginza, 7hours, Brand Shop LIPS, ALLU, Housekihiroba, BEST ISHIDA, RWW Watch, Watchfinder HK, Wristcheck, Ken's Watches, GINZA RASIN, Quark, Belle Monde, Kitamura, James Huang Vintage Watches, JD Pawn, Hourstack and RD Watch** into PostgreSQL; a Next.js frontend lets you
...
make crawl ARGS="-sources=jackroad,hourstack,watchnian,rdwatch,commitwatch,sevenhours,lips,allu,housekihiroba,ishida,rww,watchfinderhk,wristcheck,kenwatches,rasin,quark,bellemonde,kitamura,watchandtime,jdpawn -max-pages=2"
