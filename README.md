...
**Chrono24, eBay, Watchnian, Jackroad, Commit Ginza, Hourstack and RD Watch** into PostgreSQL; a Next.js frontend lets you
...
make crawl ARGS="-sources=jackroad,hourstack,watchnian,rdwatch,commitwatch -max-pages=2"
