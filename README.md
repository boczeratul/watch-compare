...
**Chrono24, eBay, Watchnian, Jackroad, Commit Ginza, 7hours, Brand Shop LIPS, ALLU, Housekihiroba, Hourstack and RD Watch** into PostgreSQL; a Next.js frontend lets you
...
make crawl ARGS="-sources=jackroad,hourstack,watchnian,rdwatch,commitwatch,sevenhours,lips,allu,housekihiroba -max-pages=2"
