...
var Brands = []BrandEntry{
	...
	{"jacob-co", "Jacob & Co.", []string{"jacob & co", "jacob &co", "jacob&co", "傑克豹", "捷克豹", "ジェイコブ"}},
	{"carl-f-bucherer", "Carl F. Bucherer", []string{"carl f. bucherer", "carl f bucherer", "bucherer", "寶齊萊", "宝齐莱", "カール f. ブヘラ", "カール・f・ブヘラ"}},
	{"doxa", "Doxa", []string{"doxa", "ドクサ", "時度"}},
	{"bulova", "Bulova", []string{"bulova", "ブローバ", "寶路華"}},
	{"vagenari", "Vagenari", []string{"vagenari", "維瑞亞"}},
